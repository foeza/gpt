...
class BlogsController extends AppController {
	...
	function index() {
		...
		$description_for_layout = sprintf(__('%s %s'), $module_title, $url_without_http);
	...
	//	cache setting
		...
		$this->set(compact(
			'module_title', 'title_for_layout', 'description_for_layout',
			'values', 'adviceCategories'
		));
	}
