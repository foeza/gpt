...
class PropertiesController extends AppController {
	...
	*/
	...
	/* ================================================================
	=================== S: PRODUCT CATEGORIES FUNC ====================
	================================================================ */
	public function admin_product_category() {
		$module_title = __('Daftar Kategori');
		$this->RmCommon->_callRefineParams($this->params);

        $options = $this->Property->PropertyProductCategory->_callRefineParams($this->params, array(
			'limit' => Configure::read('__Site.config_new_table_pagination'),
		));

        $this->paginate = $this->Property->PropertyProductCategory->getData('paginate', $options);
		$values = $this->paginate('PropertyProductCategory');
		...
		$this->render('../Product/admin_product_category');
	}

	public function admin_add_product_category() {
    	$module_title = __('Tambah Kategori Produk');
    	$user_id 	  = $this->user_id;
		...
		if( !empty($user) ) {
			$data 	= $this->request->data;
			$result = $this->Property->PropertyProductCategory->doSave( $data );
			...
			$this->render('../Product/admin_add_product_category');
		} else {
	...
	public function admin_edit_product_category( $id ) {
        $module_title = __('Edit Kategori Produk');
        $urlRedirect = array(
            'admin' 	 => true,
            'controller' => 'properties',
            'action' 	 => 'product_category',
        ...
        $data_exist = $this->Property->PropertyProductCategory->getData('first', array(
        	'conditions' => array(
		...
		if( !empty($data_exist) ) {
			$data   = $this->request->data;
			$result = $this->Property->PropertyProductCategory->doSave( $data, $data_exist, $id );
    ...
    public function admin_delete_multiple_product_category() {
		$data   = $this->request->data;
		$id     = $this->RmCommon->filterEmptyField($data, 'PropertyProductCategory', 'id');

    	$result = $this->Property->PropertyProductCategory->doDelete( $id );
