...
?>
<p>
	Berikut kami sampaikan informasi bahwa 
	<strong style="color:#333333;"><?php echo($subjectType); ?> Paket Membership Profesional</strong> Anda sudah <strong style="color:#333333;">Kadaluarsa</strong>.
</p>
<h3>Detail Order</h3>
<table style="border: 1px solid #dddddd;border-collapse: separate;width: 100%;margin-bottom: 20px;max-width: 100%;background-color: transparent;border-spacing: 0;font-family: Helvetica Neue, Helvetica, rial, sans-serif;font-size: 14px;line-height: 20px;color: #333333;">
	<tbody>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Subyek'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;border-top:none;"><?php echo($subject); ?></td>
		</tr>

		<?php if($packageName): ?>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Nama Paket'); ?></strong></td>
			<td width="70%" style="<?php echo $even; ?>border-left: 1px solid #dddddd;"><?php echo $packageName; ?></td>
		</tr>
		<?php endif; ?>

		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Nama'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;"><?php echo $senderName; ?></td>
		</tr>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Nama Perusahaan'); ?></strong></td>
			<td width="70%" style="<?php echo $even; ?>border-left: 1px solid #dddddd;"><?php echo $senderCompany; ?></td>
		</tr>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Email'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;"><?php echo $senderEmail; ?></td>
		</tr>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('No. Telp'); ?></strong></td>
			<td width="70%" style="<?php echo $even; ?>border-left: 1px solid #dddddd;"><?php echo $senderPhone; ?></td>
		</tr>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Pesan'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;"><?php echo $senderMessage; ?></td>
		</tr>
		<tr>
			<td style="<?php echo $even; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Tanggal Kirim'); ?></strong></td>
...
<table style="border: 1px solid #dddddd;border-collapse: separate;width: 100%;margin-bottom: 20px;max-width: 100%;background-color: transparent;border-spacing: 0;font-family: Helvetica Neue, Helvetica, rial, sans-serif;font-size: 14px;line-height: 20px;color: #333333;">
	<tbody>
		<tr>
			<td style="<?php echo $odd; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Nomor Invoice'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;border-top:none;"><?php echo($invoiceNumber); ?></td>
		</tr>
		<tr>
			<td style="<?php echo $odd; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Harga'); ?></strong></td>
			<td width="70%" style="<?php echo $even; ?>border-left: 1px solid #dddddd;border-top:none;"><?php echo($baseAmount); ?></td>
		</tr>
		<?php /*
		<tr>
			<td style="<?php echo $odd; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Jumlah'); ?></strong></td>
			<td width="70%" style="<?php echo $odd; ?>border-left: 1px solid #dddddd;border-top:none;"><?php echo($itemAmount); ?></td>
		</tr>
		*/ ?>
		<tr>
			<td style="<?php echo $odd; ?>border-top:none;background-color: #5eab1f;color:#ffffff;text-align: left;"><strong><?php echo __('Total'); ?></strong></td>
