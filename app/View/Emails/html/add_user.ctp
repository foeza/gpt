<?php 
		...
		echo $this->Html->tag('p', sprintf(__('Anda telah terdaftar sebagai %s di Perusahaan %s. Silakan login sesuai dengan informasi Akun yang tertera dibawah.'), $titleUser, $company_name), array(
...
<?php
		...
		echo $this->Html->tag('p', $this->Html->link($company_url, $company_url, array(
