  	...
  	<tbody>
	  	<tr>
	  		<td style="padding: 0 20px;">
	      		<?php
	      				echo $this->Html->tag('h1', sprintf(__('Menolak Akad Kredit KPR %s oleh %s'), $code, $bank), array(
	  	...
	  	<tr>
	    	<td style="padding: 0 20px;">
	      		<?php
		      			echo $this->Html->tag('h4', __('Menolak akad kredit yang Anda ajukan untuk properti:'), array(
	  	...
	  	<!-- <tr>
	    	<td style="padding: 0 20px;"> -->
	      		<?php
		    //   			echo $this->Html->tag('h4', __('Telah Menolak akad kredit sebagai berikut:'), array(
