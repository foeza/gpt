<?php 
		...
		$senderPhone 	= Common::hashEmptyField($params, 'CoBrokeUser.phone');
		...
		echo $this->Html->tag('p', sprintf(__('Anda mendapatkan permintaan kerjasama co-broking dari %s dengan kode Co-Broke %s untuk properti "%s".'), $senderName, $code, $title_properti), array(
