  	...
  	<tbody>
	  	<tr>
	  		<td style="padding: 0 20px;">
	      		<?php
	      				echo $this->Html->tag('h1', sprintf(__('Penolakan KPR %s oleh %s'), $code, $bank), array(
	  	...
	  	<tr>
	    	<td style="padding: 0 20px;">
	      		<?php
		      			echo $this->Html->tag('h4', __('Menolak referral KPR yang Anda ajukan untuk properti:'), array(
	  	...
	  	<tr>
	    	<td style="padding: 0 20px;">
	      		<?php
		      			echo $this->Html->tag('h4', __('Alasan Penolakan :'), array(
							'style' => 'font-weight:bold;text-align: left;padding-bottom:10px;font-size: 14px;margin: 0;'
						));
