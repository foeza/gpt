        	...
        	echo $this->element('blocks/common/forms/search/backend', array(
	        	...
	        	'sorting' => array(
			        ...
			        'buttonAdd' => array(
			            ...
			            'url' => array(
			            	'controller' => 'settings',
				            'action' => 'attribute_option_child_add',
				            $id,
				            'admin' => true,
		            	),
			        ),
	...
	<div class="table-responsive">
		<?php 
				...
				if( !empty($values) ) {
					$dataColumns = array(
			            'checkall' => array(
			                'name' => $this->Rumahku->buildCheckOption('AttributeOption'),
			                'class' => 'tacenter',
			            ),
			            'name' => array(
			                'name' => __('Name'),
	      	...
	      	<tbody>
	      		<?php
		      			foreach( $values as $key => $value ) {
		      				$attr_id = $this->Rumahku->filterEmptyField($value, 'AttributeOption', 'id');
		      				...
		      				echo $this->Html->tableCells(array(
				            	array(
				            		array(
				            			$this->Rumahku->buildCheckOption('AttributeOption', $attr_id, 'default'),
							            array(
							            	'class' => 'tacenter',
						            	),
				         			),
