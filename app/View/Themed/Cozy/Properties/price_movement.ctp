...
?>
<div class="agent-rank price-movement" style="background-image: url('/img/bg-rank.jpg');">
						...
						<div class="form-group">
							<?php
								...
								if($propertyTypes){
									...
									echo($this->element('blocks/activities/pus/tab', array(
										'active'	=> $activeTab, 
										'items'		=> $tabItems, 
									)));
								}
							...
							<div class="col-md-4">
								<?php
										...
										echo($this->Form->input('Search.actionid', array(
											...
											'data-wrapper-write-page' => '#wrapper-table-property-type',
										)));
								?>
							</div>
							<div class="col-md-4">
				...
				<div class="crm agent-rank">
					<div class="property-type-tab">
						<div class="project-table">
							<div id="wrapper-table-property-type" class="detail-project-table wrapper-bg-white">
								<?php
