...
(function ($) { "use strict";
    ...
    $(document).ready(function () {
        ...
        properties_initialZoom = 13,                                            //The initial zoom when properties map load 
        properties_selectedZoom = 13,                                       //The zoom to apply when an property is selected
        properties_mapInitialLatitude = null,                          //Properties map initial Latitude
        properties_mapInitialLongitude = null,                      //Properties map initial Longitude
        ...
        agency_mapInitialLatitude = $.checkUndefined( $('#company-map-latitude').val(), null ),               //Agencies map initial Latitude
        agency_mapInitialLongitude = $.checkUndefined( $('#company-map-longitude').val(), null ),            //Agencies map initial Longitude
            ...
            agencyMap: function (markers, agency_map_canvas, agency_id) {
                ...
                createMarker = function (obj) {
                    ...
                    myOptions = {
                        ...
                        closeBoxURL: "/theme/Cozy/images/close_infobox.png",
        ...
        $('.property-action-form').click(function(){
            if(typeof $(this).attr('rel') != 'undefined' && $(this).attr('rel') != ''){
                $('#property_action_id').val($(this).attr('rel'));
            }
        });
        ...
        if( $("#map_agency").length > 0 ) {
            var agencies = [
                {
                    "id": 0,
                    "title": $.checkUndefined( $('#company-map-name').val(), null ),
                    "latitude": $.checkUndefined( $('#company-map-latitude').val(), null ),
                    "longitude": $.checkUndefined( $('#company-map-longitude').val(), null ),
                    "image": $.checkUndefined( $('#company-map-logo').val(), null ),
                    "description": $.checkUndefined( $('#company-map-address').val(), '' ),
                    "link":"",
        ...
        if( $("#property_location").length > 0 ) {
            var properties = [
                {
                    "id": 0,
                    "title": $.checkUndefined( $('#property-map-name').val(), null ),
                    "latitude": $.checkUndefined( $('#property-map-latitude').val(), null ),
                    "longitude": $.checkUndefined( $('#property-map-longitude').val(), null ),
                    "image": $.checkUndefined( $('#property-map-photo').val(), null ),
                    "description": $.checkUndefined( $('#property-map-address').val(), '' ),
                    "link":"",
                    "map_marker_icon":"/theme/Cozy/images/markers/darkgrey-marker-cozy.png"
                },
            ];
