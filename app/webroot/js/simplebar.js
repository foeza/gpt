;(function (factory) {
    ...
    SimpleBar.prototype.init = function () {
        ...
        if( $('.simple-bar-top').length > 0 ) {
            $($('.simple-bar-top').attr('data-target')+' .simplebar-scroll-content').scrollTop($('.simple-bar-top').attr('data-top'));
        }
    };
...
//recalculate simplebar pada bootstrap tab
function recalcBs(){
